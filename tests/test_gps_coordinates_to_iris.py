...
from iris_insee_utils.gps_coordinates_to_iris import df_gps_to_iris, gps_to_code_iris, gps_to_iris


def test_gps_to_iris() -> None:
...
def test_gps_to_code_iris() -> None:
