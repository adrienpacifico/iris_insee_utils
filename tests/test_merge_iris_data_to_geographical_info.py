import pandas as pd
from iris_insee_utils.merge_geographical_info_to_iris_data import merge_gps_dataset_to_iris_dataset
...
def test_merge_gps_dataset_to_iris_dataset():
    ...
    df_enrich = pd.DataFrame({
        'CODE_IRIS': ['132020301', '130010905'],
        'Some_IRIS_Data': [100, 200]
    })
    
    result = merge_gps_dataset_to_iris_dataset(df_oi, df_enrich, 2018, False, ('longitude', 'latitude'), 'CODE_IRIS')
